...
Different Modifications of the reference Stereo Visual Odometry algorithm are tested and compared using the KITTI Dataset [Work in Progress]
...
Most of this implementation is borrowed from - https://github.com/NafBZ/Stereo-Visual-Odometry
